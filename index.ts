import AudioPlayer from 'player/audioplayer/implementations/AudioPlayer';
import { Looping } from 'player/audioplayer/Looping';

const player = new AudioPlayer(Looping.queue);
